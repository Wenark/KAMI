 ...
 */
public class TooltipPanel extends OrganisedContainer {

    Module module;

    public TooltipPanel(Theme theme, Module module) {
    ...
    private void prepare() {
        ...
        if (!module.getDescription().isEmpty()) {
            mods.
                ...
                String name = module.getDescription();
